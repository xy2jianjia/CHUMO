//
//  DHActivityDetailViewController.m
//  CHUMO
//
...
@interface DHActivityDetailViewController ()<UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout,JYPayWorkingDelegate,DHAlertViewDelegate>
...
@implementation DHActivityDetailViewController
...
- (void)getDataVipInfo{
    ...
    __block DHActivityDetailViewController *payVC=self;
...
- (void)getDataArr{
    ...
    [HttpOperation asyncGetVipListWithType:0 goodsCode:0 catagery:2 queue:dispatch_get_main_queue() completed:^(NSArray *vipArr, NSInteger code) {
        [self.dataArr addObjectsFromArray:[vipArr firstObject]];
        [weakSelf getDataVipInfo];
    }];
}
