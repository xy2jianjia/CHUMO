...
@interface DHUserInfoModel : NSObject
/**
 *  年龄
 */
 ...
 *  用户类型 1:注册用户,2机器
 */
@property (nonatomic,strong) NSString *b143;// 用户类型 1:注册用户,2机器人,5.动态机器人
/**
 *  是否vip 1:vip 2:非vip
 */
...
@property (nonatomic,strong) NSString *b145;
@property (nonatomic,strong) NSString *b14;// 问题
@property (nonatomic,strong) NSString *b78; // 问题类型
//@property (nonatomic,strong) NSString *ansTab; // 回答选项
//@property (nonatomic,strong) NSString *ansTabType; // 回答类型

@property (nonatomic,strong) NSMutableArray *answerArr;
/**
 *  被拉黑时间
 */
@property (nonatomic,strong) NSString *blackTime;
/**
 *  被打招呼时间
 */
