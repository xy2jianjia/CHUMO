...
#import "DBHelper.h"
static NSString * const ROBOTMESSAGETABLE = @"ROBOTMESSAGETABLE";
@implementation DHRobotMessageDao

+(instancetype)shareInstance{
    [super shareInstance];
    static DHRobotMessageDao *dao = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        dao = [[DHRobotMessageDao alloc]init];
        [dao createTable];
    });
    return dao;
}
