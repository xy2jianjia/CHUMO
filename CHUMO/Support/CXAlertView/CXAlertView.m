...
//        appearance.cancelButtonColor = [UIColor colorWithRed:0.0f green:0.5f blue:1.0f alpha:1.0f];
        appearance.cancelButtonColor = [UIColor grayColor];
...
//        appearance.customButtonColor = [UIColor colorWithRed:0.075f green:0.6f blue:0.9f alpha:1.0f];
        appearance.customButtonColor = HexRGB(0xfa5777);
//        [UIColor colorWithRed:236/255.0 green:49/255.0 blue:88/255.0 alpha:1.0f];
...
//	button.autoresizingMask = UIViewAutoresizingFlexibleWidth;
	...
	switch (type) {
		case CXAlertViewButtonTypeCancel:
            ...
            [button setTitleColor:[UIColor colorWithRed:236/255.0 green:49/255.0 blue:88/255.0 alpha:1] forState:(UIControlStateNormal)];
            [button setTitleColor:[UIColor colorWithRed:236/255.0 green:49/255.0 blue:88/255.0 alpha:1] forState:(UIControlStateHighlighted)];
			break;
