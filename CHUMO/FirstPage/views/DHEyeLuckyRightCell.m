...
@implementation DHEyeLuckyRightCell
...
-(void)config{
    ...
    // 昵称
    self.nameLabel = [[UILabel alloc] initWithFrame:CGRectMake(got(3), CGRectGetMaxY(_starButton.frame), currentHeight-gotiphon6(6), gotiphon6(15))];
...
//    // 年龄
//    self.ageLabel = [[UILabel alloc] initWithFrame:CGRectMake(got(65), currentHeight, got(28), gotHeight(20))];
//    _ageLabel.font = [UIFont systemFontOfSize:got(12)];
