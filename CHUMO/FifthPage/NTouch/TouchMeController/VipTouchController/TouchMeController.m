...
@interface TouchMeController ()<UITableViewDelegate,UITableViewDataSource,DHNoDataViewDelegate> {
...
//            [self presentViewController:refre animated:YES completion:nil];
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            [self hideHud];
//#warning 此处为==0 2016年06月16日15:37:23 --by 大海
            if (self.touchMeArray.count == 0) {
...
- (void)setupNullViewWithNoData{
    ...
    emptyView.nodataImageView.image = [UIImage imageNamed:@"touchme_nodata_icon"];
...
//        cell.headerImage.image = [UIImage imageNamed:@"seeme@1x"];
//        paraTabelView.scrollEnabled =NO; //设置tableview 不能滚动
//        return cell;
//    }else {
