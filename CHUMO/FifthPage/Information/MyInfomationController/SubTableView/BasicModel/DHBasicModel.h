...
@property (nonatomic,strong)NSString *qq;             // b156   QQ号码
@property (nonatomic,strong)NSString *qqStatus;       // b158   QQ显示状态
@property (nonatomic,strong)NSString *wx;             // b157   微信
@property (nonatomic,strong)NSString *wxStatus;       // b159   微信显示状态
@property (nonatomic,strong)NSString *dating_purpose;       // b194   交友目的
@property (nonatomic,strong)NSString *indulged;       // b195   恋爱观
@property (nonatomic,strong)NSString *meet_place;       // b196   首次见面干嘛
@property (nonatomic,strong)NSString *love_place;       // b197   爱爱地点
