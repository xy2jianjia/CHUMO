...
@interface YS_SelfPayViewController ()<DHAlertViewDelegate,JYPayWorkingDelegate,UITableViewDelegate,UITableViewDataSource,PrivilegeTableViewCellDelegate>
{
...
@implementation YS_SelfPayViewController
...
- (void)getDataArr{
    ...
    __block YS_SelfPayViewController *payVC=self;
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.section==0) {
        ...
        YS_PayInfoModel *model=self.goodInfoArr[payInfoIndexPath.row];
...
-(UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    ...
    if (section==1){
        ...
        if ([self.payComboType integerValue] ==2) {
            ...
            UILabel *label=[[UILabel alloc]initWithFrame:CGRectMake(25, 20, 70, 25)];
            ...
            UIView *leftline=[[UIView alloc]initWithFrame:CGRectMake(CGRectGetMidX(view.frame)-35-10-55, CGRectGetMidY(view.frame), 55, 0.5)];
            leftline.backgroundColor=kUIColorFromRGB(0xe4e1e6);
            [view addSubview:leftline];
            
            UIView *rightline=[[UIView alloc]initWithFrame:CGRectMake(CGRectGetMidX(view.frame)+35+10, CGRectGetMidY(view.frame), 55, 0.5)];
            rightline.backgroundColor=kUIColorFromRGB(0xe4e1e6);
...
- (void)BuyingGoodsAction:(UIButton*)sender{
    ...
    NSLog(@"一个点击事件");
    YS_PayInfoModel *Goodmodel=self.goodInfoArr[payInfoIndexPath.row];
